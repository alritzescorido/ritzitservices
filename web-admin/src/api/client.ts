...
// One fetch wrapper for the whole console. It attaches the bearer token,
// refreshes it once on a 401, turns problem+json bodies into ApiError, and
// generates the Idempotency-Key the contract requires on admin writes.

export const API_BASE: string = (import.meta.env.VITE_API_BASE as string | undefined) ?? '/v1';
const STORAGE_KEY = 'lpb.admin.session';
